    ...
    if (cartItemIndex === -1) {
      try {
        const res = await fetch(
          `https://crudcrud.com/api/51a2434ef9754a7da4a89c663e412616/cartItem${userEmail}`,
          {
            method: 'POST',
            body: JSON.stringify({
              title: product.title,
      ...
      try {
        await fetch(
          `https://crudcrud.com/api/51a2434ef9754a7da4a89c663e412616/cartItem${userEmail}/${updatedItem[cartItemIndex]._id}`,
          {
            method: 'PUT',
            body: JSON.stringify({
              title: product.title,
